...
constant.additive.gonr.methods <- method_lookup
constant.additive.gonr.score_lookup <- constant.additive.gonr.methods %>%
  left_join(score_lookup)

# execute pipeline
list(
  make_sim_spec('constant.additive.gonr.sim.params', constant.additive.gonr.sim.params, BATCH, REP),
  sim_factory('constant.additive.gonr.sim.params', X.gonr, constant.additive.gonr.spec),
  fit_factory('constant.additive.gonr.sim.params', X.gonr, constant.additive.gonr.sim, constant.additive.gonr.methods),
  score_factory('constant.additive.gonr.sim.params', constant.additive.gonr.score_lookup),
  aggegate_score_factory('constant.additive.gonr.sim.params', constant.additive.gonr.score_lookup)
)
```
