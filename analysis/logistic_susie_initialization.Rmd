...
fit_summary_tbl(fit1, 'top1') %>% select(-c(size, requested_coverage)) %>% select(c(name, everything()))
fit_summary_tbl(fit3, 'top3') %>% select(-c(size, requested_coverage)) %>% select(c(name, everything()))
fit_summary_tbl(fit5, 'top5') %>% select(-c(size, requested_coverage)) %>% select(c(name, everything()))
fit_summary_tbl(fit10, 'top10') %>% select(-c(size, requested_coverage)) %>% select(c(name, everything()))
fit_summary_tbl(fit20, 'top20') %>% select(-c(size, requested_coverage)) %>% select(c(name, everything()))
fit_summary_tbl(fit50, 'top50') %>% select(-c(size, requested_coverage)) %>% select(c(name, everything()))
```
